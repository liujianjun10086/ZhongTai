...
<body style="background:#f0f9fd;">
    ...
    <span><img src="${pageContext.request.contextPath}/images/leftico01.png" /></span>审批管理
    	...
    	<ul class="menuson">
        <li class="active"><cite></cite><a href="${pageContext.request.contextPath}/jsp/right.jsp" target="rightFrame">审批列表</a><i></i></li>
        <li><cite></cite><a href="${pageContext.request.contextPath}/jsp/imgtable.jsp" target="rightFrame">审批添加</a><i></i></li>
